...
export default function LogList() {
    ...
    return (
        <div className='space-y-4'>
            ...
            <div className='flex flex-wrap gap-4 items-end p-4 rounded-lg border'>
                ...
                <Button onClick={handleSearch}>
                    <Search className='mr-2 w-4 h-4' /> 搜索
                </Button>
            </div>
                    ...
                    {selectedLog && (
                        <div className='mt-6 space-y-6'>
                            ...
                            <div className='space-y-2'>
                                ...
                                <pre className='overflow-x-auto p-4 text-xs rounded-md border'>
                                    {JSON.stringify(
                                        JSON.parse(selectedLog.params || '{}'),
                                        null,
                                        2
                                    )}
                                </pre>
                            ...
                            {selectedLog.status === 1 ? (
                                ...
                                <div className='space-y-2'>
                                    ...
                                    <pre className='overflow-x-auto p-4 text-xs rounded-md border text-destructive border-destructive/20'>
                            ...
                            <div className='pb-6 space-y-2'>
                                ...
                                <div className='p-3 text-xs break-all rounded-md border'>
